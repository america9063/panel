			...
			@if(count($streams) <= 14)
			 ...
			 @endif
                    ...
                    <form action=""method="post">
                        <input disabled type="submit" name="mass_start" value="Mass start" class="btn btn-small btn-success" onclick="return confirm('Are you sure?')">
                        <input disabled  type="submit" name="mass_stop" value="Mass stop" class="btn btn-small btn-danger" onclick="return confirm('Are you sure?')">
				    ...
				    <th>Stream ID</th>
                                ...
                                @foreach($streams as $key => $stream)
                                    <tr>
                                        ...
                                        <td class="center"><span class="label label-{{ $stream->status_label['label'] }}"><font size=2>id {{ $stream->id }}</span></td>
