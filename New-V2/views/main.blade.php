...
HLS Transcode live streaming Panel Management

website: www.hlsserver.com
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.php" class="site_title"> <span><span>HLSSERVER <small style="font-size: 10px;">panel</small></span></span></a>
                </div>
			    ...
			    <li><a href="#" onclick="alert('only self hoster version')"><i class="fa fa-reorder"></i> Transcode profiles </a></li>
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><i class="fa fa-setting"></i> Max Channels: <b>15</b> </li>
                            <li> <i class="fa fa-setting"></i> Type: <b>Single HLSServer</b> </li>
                            <li><a target="_new" href="http://www.hlsserver.com"><i class="fa fa-laptop"></i> Website </a></li>
                        </ul>
                    </div>
