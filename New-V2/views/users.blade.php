                        ...
                        <table id="example" class="table table-striped responsive-utilities jambo_table bulk_action">
                            ...
                            @foreach($users as $key => $user)
                                <tr>
                                    ...
                                    <td class="center">
                                        <a href="clientsgen.php?u={{$user->username}}&uid={{ $user->id }}" title="Clients"><span class="label label-success"><font size=2>Stream Token APIs</span></a>
                                    ...
                                    <td class="center">
                                        <a class="btn btn-info" href="manage_user.php?id={{ $user->id }}" title="Show / Edit">Show / Edit</a>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
			<textarea name="" id="" class="col-md-12" rows="3">wget -O /etc/enigma2/iptv.sh "http://{{ $setting->webip }}:{{ $setting->webport }}/getEnigma/{{$user->username}}/{{$user->password}}" && chmod 777 /etc/enigma2/iptv.sh && /etc/enigma2/iptv.sh
			</textarea>
		    </p>
                </div>
