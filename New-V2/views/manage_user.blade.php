                    ...
                    @if(count($categories) > 0)
                        ...
                        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" role="form" action="" method="post">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Current API:</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="api" class="form-control col-md-7 col-xs-12"  value="{{  $user->password}}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
